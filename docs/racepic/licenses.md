...
## 6. PAID_PRIVATE – interne Shop-Vorbereitung (2026-09-22)

Die Datenbank kennt nun eine versionierte Lizenz PAID_PRIVATE mit pricing_kind PAID. Fotograf:innen können an einem noch unveröffentlichten Bild einen EUR-Preis für private Nutzung und einen hochauflösenden Download hinterlegen. Die Vorschau im Studio trägt ein Wasserzeichen. Das Angebot bleibt bis zur Einführung von Kauf, Verkäuferidentifikation und Berechtigungsprüfung vollständig privat: weder öffentliche Galerie noch öffentlicher Download geben es aus.

Vorgesehener Vertragspartner beim späteren Kauf ist der jeweilige Fotograf; der MSC vermittelt. Vor dem Checkout sind die steuerliche Einordnung, Pflichtinformationen zum Verkäufer, Rechnungsstellung, Widerrufsbelehrung und die Zuordnung der Zahlungsströme zu prüfen. Eine pauschale Klausel zum Erlöschen des Widerrufsrechts ist nicht vorgesehen; für sofort bereitgestellte digitale Inhalte müssen die Voraussetzungen des [§ 356 Abs. 5 BGB](https://www.gesetze-im-internet.de/bgb/__356.html) im konkreten Kaufablauf erfüllt und dokumentiert werden. Die umsatzsteuerliche Rolle der Plattform ist anhand von [§ 3 Abs. 11 und 11a UStG](https://www.gesetze-im-internet.de/ustg_1980/__3.html) zu prüfen.
