...
const navItems = [
  ...
  { href: '/admin/events', label: 'Oberlausitzer Dreieck', icon: Trophy },
  { href: '/admin/news', label: 'News', icon: Newspaper },
  { href: '/admin/calendar', label: 'Terminkalender', icon: CalendarDays },
  { href: '/admin/content', label: 'Seiten & Texte', icon: FileText },
  { href: '/admin/board', label: 'Vorstand', icon: Users },
  { href: '/admin/partner-clubs', label: 'Partnervereine', icon: FolderTree },
